...
export interface AdminMember {
  ...
  name: string;
  email: string;
  plan: 'Free' | 'Lifetime' | 'Coaching' | 'Business';
  streak: number;
  lastActive: string;
  joinedAt: string;
...
const initialState: AdminState = {
  ...
  pricing: {
    ...
    tiers: [
    {
      ...
      price: 297,
      description: 'One-time payment, lifetime access to all programs.',
      active: true
    },
    {
      id: 'tier-loyalty',
      ...
      price: 19,
      description:
      'Returning members renewing past Lifetime — discounted monthly.',
      active: true
    },
    {
      id: 'tier-coaching',
      ...
      price: 97,
      description: '1-on-1 monthly coaching call with a certified coach.',
      active: true
    }]
